...
predict.haystack.randomforest<-function(x,model){
    #      get list of predictions of the Haystack
    #      object dataset using randomforest predictive model
...
predict.haystack.glm<-function(x,model){
    #      get list of predictions of the Haystack object
    #      dataset using Generalized linear model predictive model
